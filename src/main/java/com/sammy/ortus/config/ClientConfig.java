...
public class ClientConfig extends OrtusConfig {
    ...
    public static ConfigValueHolder<Boolean> DELAYED_PARTICLE_RENDERING = new ConfigValueHolder<>(INSTANCE, "client/graphics/particle", builder ->
    ...
    public static ConfigValueHolder<Double> FIRE_OVERLAY_OFFSET = new ConfigValueHolder<>(INSTANCE, "client/graphics/fire", builder ->
    ...
    public static ConfigValueHolder<Double> SCREENSHAKE_INTENSITY = new ConfigValueHolder<>(INSTANCE, "client/screenshake", builder ->
