...
/**
 * A basic provider for your ortus capability
 */
public class OrtusCapabilityProvider<C extends INBTSerializable<CompoundTag>> implements ICapabilityProvider, INBTSerializable<CompoundTag> {
