package com.sammy.ortus.systems.item.tools;
...
public class OrtusKnifeItem extends KnifeItem {
    private Multimap<Attribute, AttributeModifier> attributes;

    public OrtusKnifeItem(Tier tier, float attackDamageIn, float attackSpeedIn, Properties properties) {
