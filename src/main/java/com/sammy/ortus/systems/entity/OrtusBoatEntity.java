package com.sammy.ortus.systems.entity;
...
public class OrtusBoatEntity extends Boat
{
    private final RegistryObject<Item> boatItem;
    private final RegistryObject<Item> plankItem;
    public OrtusBoatEntity(EntityType<? extends OrtusBoatEntity> type, Level level, RegistryObject<Item> boatItem, RegistryObject<Item> plankItem)
    {
        super(type, level);
