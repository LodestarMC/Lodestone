...
public class PaintingRegistry {
    ...
    public static void register(IEventBus bus){
        ...
        OrtusTextureLoader.copyTextureWithChanges(OrtusLib.ortusPrefix("lefunny.png"),OrtusLib.ortusPrefix("microfunny.png"),OrtusLib.ortusPrefix("textures/painting/microfunny.png"),(image) -> image);
