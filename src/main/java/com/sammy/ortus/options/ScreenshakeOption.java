...
public class ScreenshakeOption extends ProgressOption implements OrtusOption {
    ...
    private static final Component TOOLTIP = new TranslatableComponent(OrtusLangDatagen.getOptionTooltip("screenshake_intensity"));

    public ScreenshakeOption() {
        super(OrtusLangDatagen.getOption("screenshake_intensity"),
                0.0D,
                1.0D,
                0.01F,
