...
public class OrtusRenderTypeRegistry extends RenderStateShard {
    ...
    public static final RenderType ADDITIVE_PARTICLE = createGenericRenderType(ORTUS, "additive_particle", PARTICLE, VertexFormat.Mode.QUADS, OrtusShaderRegistry.ORTUS_PARTICLE.shard, StateShards.ADDITIVE_TRANSPARENCY, TextureAtlas.LOCATION_PARTICLES);
    ...
    public static final RenderType TRANSPARENT_PARTICLE = createGenericRenderType(ORTUS, "transparent_particle", PARTICLE, VertexFormat.Mode.QUADS, OrtusShaderRegistry.ORTUS_PARTICLE.shard, StateShards.NORMAL_TRANSPARENCY, TextureAtlas.LOCATION_PARTICLES);
