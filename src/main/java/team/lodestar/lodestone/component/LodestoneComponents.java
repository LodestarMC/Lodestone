...
public class LodestoneComponents implements EntityComponentInitializer, WorldComponentInitializer {
    ...
    public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
        ...
        registry.beginRegistration(LivingEntity.class, LODESTONE_ENTITY_COMPONENT).respawnStrategy(RespawnCopyStrategy.NEVER_COPY).end(LodestoneEntityComponent::new);
    }
}
