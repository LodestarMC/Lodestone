...
import team.lodestar.lodestone.helpers.AngleHelper;
import team.lodestar.lodestone.helpers.VecHelper;
import team.lodestar.lodestone.helpers.util.Color;
import team.lodestar.lodestone.helpers.util.special.SpecialTextures;
import team.lodestar.lodestone.helpers.util.transforms.TransformStack;
...
public abstract class Outline {
    ...
    public void renderAACuboidLine(PoseStack ms, Vec3 start, Vec3 end) {
        ...
        VertexConsumer builder = RenderHandler.DELAYED_RENDER.getBuffer(LodestoneRenderTypeRegistry.OUTLINE_SOLID);
        ...
        Vec3 extension = diff.normalize()
                .scale(lineWidth / 2);
        Vec3 plane = VecHelper.axisAlignedPlaneOf(diff);
