...
public final class ParticleEditorOverlayRenderer {
    ...
    private ParticleEditorOverlayRenderer() {
    }
    ...
    static void renderShape(PoseStack poseStack, Camera camera, Vec3 center, ParticleEditorState state, int colorIndex) {
