...
public class DirectionalParticle<T extends LodestoneParticleBehavior<T>> extends LodestoneWorldParticle<T> {
    ...
    public DirectionalParticle(ClientLevel world, DirectionalParticleOptions<T> data, ParticleEngine.MutableSpriteSet spriteSet, double x, double y, double z, double xd, double yd, double zd) {
