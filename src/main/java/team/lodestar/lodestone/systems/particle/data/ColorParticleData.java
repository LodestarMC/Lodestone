...
public class ColorParticleData {
    ...
    public static ColorParticleDataBuilder create(ColorParticleData data) {
        return create(data.r1, data.g1, data.b1, data.r2, data.g2, data.b2).setCoefficient(data.colorCoefficient).setEasing(data.colorCurveEasing);
    }
