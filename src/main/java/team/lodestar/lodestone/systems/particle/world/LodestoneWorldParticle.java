...
public class LodestoneWorldParticle<T extends LodestoneParticleBehavior<T>> extends TextureSheetParticle {
    ...
    public LodestoneWorldParticle(ClientLevel world, WorldParticleOptions<T> options, FabricSpriteProviderImpl spriteSet, double x, double y, double z, double xd, double yd, double zd) {
        super(world, x, y, z);
